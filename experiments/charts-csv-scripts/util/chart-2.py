...
with PdfPages('../charts-csv-scripts/charts/'+sys.argv[1]+'.pdf') as pdf:
    ...
    #matplotlib.pyplot.legend(bbox_to_anchor=(1, 1.0), loc="upper left")
    matplotlib.pyplot.legend(loc='upper center', bbox_to_anchor=(0.5, -0.1), fancybox=True, shadow=True, ncol=6)
